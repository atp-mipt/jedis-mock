...
public class TestBZMPop {
    ...
    private Jedis blockedClient3;
    private Jedis blockedClient4;
    ...
    public void setUp(Jedis jedis, HostAndPort hostAndPort) {
        ...
        blockedClient3 = new Jedis(hostAndPort.getHost(), hostAndPort.getPort());
        blockedClient4 = new Jedis(hostAndPort.getHost(), hostAndPort.getPort());
    ...
    @TestTemplate
    public void testBZMPopEnsureItTimeout(Jedis jedis) throws ExecutionException, InterruptedException, TimeoutException {
        String key1 = "qwe";
        String key2 = "asd";
        String key3 = "zxc";
    ...
    @TestTemplate
    public void testBZMPopMultipleBlockingClients(Jedis jedis) throws ExecutionException, InterruptedException, TimeoutException {
        String key1 = "qwe";
        String key2 = "asd";
        ...
        Future<?> future = blockingThread.submit(() -> {
            ...
            KeyValue<String, List<Tuple>> result3 = blockedClient3.bzmpop(0, SortedSetOption.MIN, 10, key1, key2);
            KeyValue<String, List<Tuple>> expected3 = new KeyValue<>(key2, Arrays.asList(
                    new Tuple("a", 1.0),
                    new Tuple("b", 2.0),
                    new Tuple("c", 3.0),
                    new Tuple("d", 4.0),
            ...
            KeyValue<String, List<Tuple>> result4 = blockedClient4.bzmpop(0, SortedSetOption.MAX, 1, key1, key2);
            KeyValue<String, List<Tuple>> expected4 = new KeyValue<>(key2, Collections.singletonList(new Tuple("c", 3.0)));
